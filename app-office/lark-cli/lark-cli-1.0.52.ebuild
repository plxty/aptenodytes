...
SRC_URI="
  https://open.feishu.cn/api/tools/open/api_definition?protocol=meta&client_version=v${PV} -> meta_data.json
...
src_prepare() {
  default
  jq ".data" < "${DISTDIR}/meta_data.json" > internal/registry/meta_data.json
